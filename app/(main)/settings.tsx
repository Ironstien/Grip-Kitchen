      ...
      {activeTab === 'general' && (
        <View className="gap-4">
          ...
          <Text variant="caption">
            More settings (export, account delete) arrive in Phase 5. Currency is fixed to AUD.
          </Text>
        </View>
      )}
      ...
      <MasterDetailLayout master={<SettingsTabs activeTab={activeTab} onChange={setActiveTab} />}>
        <View className="flex-1 bg-surface dark:bg-surface-dark">
          <DetailPaneHeader
            ...
            subtitle="Manage categories, units, locations, and preferences."
          />
          <ScrollView
            className="flex-1"
    ...
    <ScrollView
      ...
      <View className="mb-4">
        ...
        <Text variant="caption" className="mt-0.5">
          Manage categories, units, locations, and preferences.
        </Text>
      </View>
