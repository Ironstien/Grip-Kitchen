...
import { formatDayShort, getMonthDates, toDateKey } from '@/lib/mealPlan/dates';
...
export function MonthPlannerView({
  ...
  const monthDays = useMemo(() => getMonthDates(monthAnchor), [monthAnchor]);
              ...
              {MEAL_SLOTS.map((mealLabel) => {
                ...
                return (
                  <MealSlotCard
                    ...
                    onEdit={
                      entry ? () => onSlotEdit(dateKey, mealLabel, entry) : undefined
                    }
                  />
                );
              })}
